...
namespace Thinktecture.Threading.Tasks
{
...
#endif
	{
		...
		void Start([NotNull] TaskScheduler scheduler);
		...
		/// <exception cref="T:System.ArgumentNullException">The <paramref name="scheduler" /> argument is null.</exception>
		/// <exception cref="T:System.InvalidOperationException">The <see cref="T:System.Threading.Tasks.Task" /> is not in a valid state to be started. It may have already been started, executed, or canceled, or it may have been created in a manner that doesn't support direct scheduling.</exception>
		void RunSynchronously([NotNull] TaskScheduler scheduler);
		...
		/// <exception cref="T:System.ArgumentNullException">The <paramref name="continuationAction" /> argument is null.</exception>
		[NotNull]
		ITask ContinueWith([NotNull] Action<ITask> continuationAction, CancellationToken cancellationToken);
		...
		[NotNull]
		ITask ContinueWith([NotNull] Action<ITask> continuationAction, TaskContinuationOptions continuationOptions);
		...
		[NotNull]
		ITask ContinueWith([NotNull] Action<ITask, object> continuationAction, [CanBeNull] object state, CancellationToken cancellationToken);
		...
		/// <exception cref="T:System.ArgumentOutOfRangeException">The <paramref name="continuationOptions" /> argument specifies an invalid value for <see cref="T:System.Threading.Tasks.TaskContinuationOptions" />.</exception>
		[NotNull]
		ITask ContinueWith([NotNull] Action<ITask, object> continuationAction, [CanBeNull] object state, TaskContinuationOptions continuationOptions);
		...
		/// <exception cref="T:System.ArgumentNullException">The <paramref name="continuationFunction" /> argument is null.</exception>
		[NotNull]
		ITask<TResult> ContinueWith<TResult>([NotNull] Func<ITask, TResult> continuationFunction, CancellationToken cancellationToken);
		...
		/// <exception cref="T:System.ArgumentOutOfRangeException">The <paramref name="continuationOptions" /> argument specifies an invalid value for <see cref="T:System.Threading.Tasks.TaskContinuationOptions" />.</exception>
		[NotNull]
		ITask<TResult> ContinueWith<TResult>([NotNull] Func<ITask, TResult> continuationFunction, TaskContinuationOptions continuationOptions);
		...
		/// <exception cref="T:System.ObjectDisposedException">The provided <see cref="T:System.Threading.CancellationToken" /> has already been disposed.</exception>
		[NotNull]
		ITask<TResult> ContinueWith<TResult>([NotNull] Func<ITask, object, TResult> continuationFunction, [CanBeNull] object state, CancellationToken cancellationToken);
		...
		/// <exception cref="T:System.ObjectDisposedException">The provided <see cref="T:System.Threading.CancellationToken" /> has already been disposed.</exception>
		[NotNull]
		ITask<TResult> ContinueWith<TResult>([NotNull] Func<ITask, object, TResult> continuationFunction, [CanBeNull] object state, CancellationToken cancellationToken, TaskContinuationOptions continuationOptions, [NotNull] TaskScheduler scheduler);
	}
	...
	public interface ITask<TResult> : IAbstraction<Task<TResult>>, ITask
	{
		...
		/// <exception cref="T:System.ArgumentNullException">The <paramref name="continuationAction" /> argument is null. </exception>
		[NotNull]
		ITask ContinueWith([NotNull] Action<ITask<TResult>> continuationAction, CancellationToken cancellationToken);
		...
		/// <exception cref="T:System.ArgumentOutOfRangeException">The <paramref name="continuationOptions" /> argument specifies an invalid value for <see cref="T:System.Threading.Tasks.TaskContinuationOptions" />.</exception>
		[NotNull]
		ITask ContinueWith([NotNull] Action<ITask<TResult>> continuationAction, TaskContinuationOptions continuationOptions);
		...
		/// <exception cref="T:System.ObjectDisposedException">The provided <see cref="T:System.Threading.CancellationToken" /> has already been disposed.</exception>
		[NotNull]
		ITask ContinueWith([NotNull] Action<ITask<TResult>, object> continuationAction, [CanBeNull] object state, CancellationToken cancellationToken);
		...
		/// <exception cref="T:System.ArgumentOutOfRangeException">The <paramref name="continuationOptions" /> argument specifies an invalid value for <see cref="T:System.Threading.Tasks.TaskContinuationOptions" />.</exception>
		[NotNull]
		ITask ContinueWith([NotNull] Action<ITask<TResult>, object> continuationAction, [CanBeNull] object state, TaskContinuationOptions continuationOptions);
		...
		/// <exception cref="T:System.ArgumentNullException">The <paramref name="continuationFunction" /> argument is null.</exception>
		[NotNull]
		ITask<TNewResult> ContinueWith<TNewResult>([NotNull] Func<ITask<TResult>, TNewResult> continuationFunction, CancellationToken cancellationToken);
		...
		/// <exception cref="T:System.ArgumentOutOfRangeException">The <paramref name="continuationOptions" /> argument specifies an invalid value for <see cref="T:System.Threading.Tasks.TaskContinuationOptions" />.</exception>
		[NotNull]
		ITask<TNewResult> ContinueWith<TNewResult>([NotNull] Func<ITask<TResult>, TNewResult> continuationFunction, TaskContinuationOptions continuationOptions);
		...
		/// <exception cref="T:System.ObjectDisposedException">The provided <see cref="T:System.Threading.CancellationToken" /> has already been disposed.</exception>
		[NotNull]
		ITask<TNewResult> ContinueWith<TNewResult>([NotNull] Func<ITask<TResult>, object, TNewResult> continuationFunction, [CanBeNull] object state, CancellationToken cancellationToken);
		...
		/// <exception cref="T:System.ObjectDisposedException">The provided <see cref="T:System.Threading.CancellationToken" /> has already been disposed.</exception>
		[NotNull]
		ITask<TNewResult> ContinueWith<TNewResult>([NotNull] Func<ITask<TResult>, object, TNewResult> continuationFunction, [CanBeNull] object state, CancellationToken cancellationToken, TaskContinuationOptions continuationOptions, [NotNull] TaskScheduler scheduler);
	}
}
