...
namespace Thinktecture
{
   ...
   public static class SocketExtensions
   {
      ...
      /// <returns>An asynchronous Task.</returns>
      public static ValueTask ConnectAsync(this ISocket socket, EndPoint remoteEp, CancellationToken cancellationToken)
      {
         return socket.ToImplementation().ConnectAsync(remoteEp, cancellationToken);
      }
      ...
      /// <param name="cancellationToken">Cancellation token.</param>
      /// <returns>An asynchronous Task.</returns>
      public static ValueTask ConnectAsync(this ISocket socket, IEndPoint remoteEp, CancellationToken cancellationToken)
      {
         return socket.ToImplementation().ConnectAsync(remoteEp.ToImplementation(), cancellationToken);
      }
#endif
      ...
      /// <param name="cancellationToken">Cancellation token.</param>
      /// <returns>An asynchronous Task.</returns>
      public static ValueTask ConnectAsync(this ISocket socket, IPAddress address, int port, CancellationToken cancellationToken)
      {
         return socket.ToImplementation().ConnectAsync(address, port, cancellationToken);
      }
      ...
      /// <param name="cancellationToken">Cancellation token.</param>
      /// <returns>An asynchronous Task.</returns>
      public static ValueTask ConnectAsync(this ISocket socket, IIPAddress address, int port, CancellationToken cancellationToken)
      {
         return socket.ToImplementation().ConnectAsync(address.ToImplementation(), port, cancellationToken);
      }
#endif
      ...
      {
         return socket.ToImplementation().ConnectAsync(addresses.ToNotNullImplementation<IIPAddress, IPAddress>(), port);
      }
      ...
      /// <param name="cancellationToken">Cancellation token.</param>
      /// <returns>A task that represents the asynchronous connect operation.</returns>
      public static ValueTask ConnectAsync(this ISocket socket, IPAddress[] addresses, int port, CancellationToken cancellationToken)
      {
         return socket.ToImplementation().ConnectAsync(addresses, port, cancellationToken);
      }
      ...
      /// <param name="cancellationToken">Cancellation token.</param>
      /// <returns>A task that represents the asynchronous connect operation.</returns>
      public static ValueTask ConnectAsync(this ISocket socket, IIPAddress[] addresses, int port, CancellationToken cancellationToken)
      {
         return socket.ToImplementation().ConnectAsync(addresses.ToNotNullImplementation<IIPAddress, IPAddress>(), port, cancellationToken);
      }
#endif
