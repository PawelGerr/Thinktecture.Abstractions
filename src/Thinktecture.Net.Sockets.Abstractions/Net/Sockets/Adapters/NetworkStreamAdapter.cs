...
namespace Thinktecture.Net.Sockets.Adapters
{
   ...
   public class NetworkStreamAdapter : StreamAdapter, INetworkStream
   {
...
#if NET5_0
      /// <inheritdoc />
      public Socket Socket => Implementation.Socket;
#endif
      ...
      public NetworkStreamAdapter(Socket socket, FileAccess access)
      ...
      /// -or-
      /// the <paramref name="socket">socket</paramref> parameter is in a nonblocking state.</exception>
      public NetworkStreamAdapter(Socket socket, FileAccess access, bool ownsSocket)
