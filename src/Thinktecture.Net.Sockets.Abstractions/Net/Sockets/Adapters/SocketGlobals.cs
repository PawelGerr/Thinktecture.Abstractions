...
namespace Thinktecture.Net.Sockets.Adapters
{
   ...
   public class SocketGlobals : ISocketGlobals
   {
      ...
      public bool OSSupportsIPv4 => Socket.OSSupportsIPv4;
      ...
      // ReSharper disable once InconsistentNaming
      public bool OSSupportsIPv6 => Socket.OSSupportsIPv6;

#if NET5_0
      /// <summary>
      /// Indicates whether the underlying operating system support the Unix domain sockets.
      /// </summary>
      public bool OSSupportsUnixDomainSockets => Socket.OSSupportsUnixDomainSockets;
#endif
