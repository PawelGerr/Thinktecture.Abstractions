...
namespace Thinktecture.IO.Adapters
{
   ...
   public class TextWriterAdapter : AbstractionAdapter<TextWriter>, ITextWriter
   {
      ...
      /// <inheritdoc />
      public void Write(IStringBuilder? value)
      {
         Write(value.ToImplementation());
      }
      ...
      /// <inheritdoc />
      public Task WriteAsync(IStringBuilder? value, CancellationToken cancellationToken = default)
      {
         return WriteAsync(value.ToImplementation(), cancellationToken);
      }

      /// <inheritdoc />
      public Task WriteAsync(StringBuilder? value, CancellationToken cancellationToken = default)
      {
         return Implementation.WriteAsync(value, cancellationToken);
      }
#endif
      ...
      /// <inheritdoc />
      public void WriteLine(IStringBuilder? value)
      {
         WriteLine(value.ToImplementation());
      }
...
#if NETCOREAPP || NET5_0
      /// <inheritdoc />
      public Task WriteLineAsync(IStringBuilder? value, CancellationToken cancellationToken = default)
      {
         return Implementation.WriteLineAsync(value.ToImplementation(), cancellationToken);
      }

      /// <inheritdoc />
      public Task WriteLineAsync(StringBuilder? value, CancellationToken cancellationToken = default)
      {
         return Implementation.WriteLineAsync(value, cancellationToken);
      }
#endif
   }
}
